...
## Run contrast generation
Run the program named `mri_contrast_gen.py`, the program will generate an url link. E.g.:`Running on local URL:  http://127.0.0.1:7860`

Copy the url and open it in your web browser.

After open the link, fill in the path to your R1 Map/R2 Map/PD Map dicom files. For example, `/Users/amadeus/Downloads/SyMRI_processed_DL/HD_1_DL/1202_R1_MAP_AX`. Then you can tune the parameters and click on the `Submit` button.
